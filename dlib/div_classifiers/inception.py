...
class ClassifierA(nn.Module):
    def __init__(self, num_classes: int):
        ...
        self.conv1 = nn.Conv2d(768, 1024, kernel_size=3, stride=1, padding=1)
        self.relu = nn.ReLU(False)
        self.conv2 = nn.Conv2d(1024, 1024, kernel_size=3, stride=1, padding=1)
        self.conv3 = nn.Conv2d(1024, num_classes, kernel_size=1, padding=0)
...
class InceptionV3Acol(AcolBase, CoreClassifier):
    def __init__(self,
        ...
        # )
        self.classifier_A = ClassifierA(num_classes)
        ...
        self.encoder_n_out_channels = 768
    ...
    def forward(self, x, labels=None):
        ...
        self.encoder_last_features = feature  # bsz, 768, h, w

        self.logits_dict = self._acol_logits(feature=feature,
                                             labels=labels,
...
class InceptionV3Spg(CoreClassifier):
    def __init__(self,
        ...
        self.encoder_last_features = None
        self.encoder_n_out_channels = 1024
    ...
    def forward(self, x, labels=None):
        ...
        self.encoder_last_features = x  # bsz, 1024, h, w
